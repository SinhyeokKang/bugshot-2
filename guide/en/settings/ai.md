...
![Connecting an AI model](../assets/dummy.jpg)

## Two features it turns on

Connecting an LLM enables two AI features. Without a connection, neither appears in the UI — so connect whenever you need them.
