...
| AI 로그 코드블럭 자동 삽입(logRefs) | `src/sidepanel/lib/prompts/logCandidates.ts`(후보 단일 출처·description 게이트) · `renderLogRefs.ts`(상한 3·역참조·삽입) · `mergeAiDraftSections.ts`(코드블럭 보존) · 배선 `src/sidepanel/tabs/AiDraftDialog.tsx` |
