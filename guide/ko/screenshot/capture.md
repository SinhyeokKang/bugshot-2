...
![영역 드래그 선택](../.gitbook/assets/screenshot-capture-1.jpg)
...
![요소 캡처 선택](../.gitbook/assets/screenshot-capture-2.jpg)
...
> **요소 캡처**는 스타일을 바꾸지 않습니다. 요소를 골라 before/after로 스타일을 비교하려면 [요소 선택 & 스타일링](../element/)을 이용하세요.
