...
애써 만든 리포트도 결국 팀이 쓰는 이슈 트래커로 가야 빛을 발하죠. **연동** 탭에서 Jira·GitHub·Linear·Notion·GitLab·Asana·ClickUp 중 쓰시는 플랫폼을 연결해 두면(팀 채널로 가볍게 공유할 Slack, 직접 만든 서버로 보낼 Custom Webhook도 같은 자리에 있습니다), 캡처한 버그를 그 플랫폼의 이슈로 바로 등록할 수 있습니다. 정식 이슈 전에 팀에 빠르게 공유하고 싶다면 **Slack**으로도 보낼 수 있습니다.
