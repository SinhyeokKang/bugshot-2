...
- **액션 로그** — 클릭·텍스트 입력·페이지 이동은 물론, **단축키·특수키 입력(Enter·Esc·⌘K 등), 체크박스·라디오 토글, 드롭다운 선택**까지 사용자 동작을 폭넓게 기록합니다. (입력한 글자 하나하나가 아니라 어떤 키·동작을 했는지가 담깁니다.) **액션 로그는 녹화 모드에서만 수집됩니다.**
