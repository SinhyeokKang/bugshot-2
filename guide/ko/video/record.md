...
**디버그** 탭의 녹화 버튼은 설정에서 고른 모드(**탭 녹화** / **화면 녹화**)대로 동작합니다. 모드는 **설정 > 이슈 설정 > 녹화 설정 > 녹화 모드**에서 고르거나, 녹화 버튼 오른쪽 **톱니바퀴(⚙)**를 눌러 설정으로 바로 이동해 바꿀 수 있어요. 고른 모드는 녹화 버튼의 아이콘과 라벨에 바로 반영됩니다.
