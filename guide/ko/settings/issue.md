...
![제목 접두어 설정](../.gitbook/assets/settings-issue-1.jpg)

이슈 제목 앞에 자동으로 붙는 문구입니다. 예를 들어 `[QA]` 로 두면 제목이 늘 `[QA]` 로 시작합니다. 팀에서 라벨 규칙을 쓰신다면 꽤 요긴합니다.

## 녹화 모드

![녹화 모드 설정](../.gitbook/assets/settings-issue-2.jpg)
...
![30초 리플레이 토글](../.gitbook/assets/settings-issue-3.jpg)
...
![본문 구성 설정](../.gitbook/assets/settings-issue-4.jpg)
...
![파일 첨부 토글](../.gitbook/assets/settings-issue-5.jpg)
