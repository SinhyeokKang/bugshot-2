...
BugShot의 화면 언어를 고릅니다. **한국어**, **English**, **Français** 중에서 선택할 수 있어요. 고르는 즉시 사이드패널 전체에 반영되니, 따로 새로고침하지 않으셔도 됩니다.

> 사용 가이드는 한국어와 영어로 제공돼요. 한국어로 두면 한국어 가이드로, 그 외 언어로 두면 영어 가이드로 연결됩니다.
