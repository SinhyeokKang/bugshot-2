...
이슈를 보내려면 플랫폼이 하나는 연결되어 있어야 합니다. **연동** 탭에서 Jira·GitHub·Linear·Notion·GitLab·Asana·ClickUp 중 하나만 연결하면 됩니다(Slack이나 직접 만든 서버로 보내는 Custom Webhook도 됩니다). 자세한 방법은 [플랫폼 연동](integrations/platforms.md)에서 차근차근 안내해 드립니다.
