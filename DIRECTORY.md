...
│   │   ├── connect/       # 플랫폼별 연결 폼 (JiraConnectForm, GithubConnectForm, LinearConnectForm, NotionConnectForm) + ConnectMethodDialog(OAuth/토큰 연결 수단 선택 다이얼로그) — IntegrationsTab 'add' 서브탭 content
