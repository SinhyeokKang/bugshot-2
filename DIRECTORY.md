...
├── log-viewer/          # Self-contained HTML 로그 뷰어 (별도 Vite 빌드 → dist-log-viewer/index.html 단일 파일). Network/Console 탭, 다크모드, HAR/JSON 다운로드. 경량 i18n(navigator.language 기반)
