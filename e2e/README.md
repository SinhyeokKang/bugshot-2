...
- `basic.html` — `#title`(color·padding 명시), `#card.card.box`, `#el1`–`#el3`(`.swatch` — 다요소 버퍼·재선택용), `#quad`(inline `padding:4px 8px 12px 16px` — 4면 상이, linked auto-derive 검증용), `#filler`(2000px).
