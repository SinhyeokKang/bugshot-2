...
| `chrome.tabs.get() → tab.url` | 탭 URL 읽기 | `tab-bindings.ts:160`, `picker-control.ts:177,204,446(pageKeyOf),565`, `video-capture.ts:49`, `video-recorder.ts:84`, `use-30s-replay.ts:68,149` |
