...
| API | 용도 | 사용 위치 |
|---|---|---|
| `chrome.tabs.captureVisibleTab()` | 요소·영역·30s Replay 스크린샷 | `background/messages.ts:187` (bg handler) |
...
| `chrome.scripting.executeScript()` | content script 재주입·뷰포트 측정 | `picker-control.ts:39,69,86,609` |
