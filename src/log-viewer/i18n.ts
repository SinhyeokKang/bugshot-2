...
export const koDict: Record<string, string> = {
  ...
  "networkLog.display.queueFull": "실패 · 큐 가득 참",
  ...
  "actionLog.verb.navigateBack": "{target}(으)로 뒤로가기",
  "actionLog.verb.navigateForward": "{target}(으)로 앞으로가기",
  "actionLog.verb.navigateReload": "{target} 새로고침",
  "actionLog.verb.navigateTraverse": "{target}(으)로 히스토리 이동",
...
export const enDict: Record<string, string> = {
  ...
  "networkLog.display.queueFull": "Failed · queue full",
  ...
  "actionLog.verb.navigateBack": "Went back to {target}",
  "actionLog.verb.navigateForward": "Went forward to {target}",
  "actionLog.verb.navigateReload": "Reloaded {target}",
  "actionLog.verb.navigateTraverse": "Navigated via history to {target}",
...
export const frDict: Record<string, string> = {
  "networkLog.search": "Rechercher URL et corps…",
  "networkLog.filter.all": "Toutes",
  "networkLog.filter.json": "JSON",
  "networkLog.filter.js": "JS",
  "networkLog.filter.css": "CSS",
  "networkLog.filter.img": "Img",
  "networkLog.filter.font": "Police",
  "networkLog.filter.doc": "Doc",
  "networkLog.filter.other": "Autres",
  "networkLog.filter.ws": "WS",
  "networkLog.dialog.selectRequest": "Sélectionnez une requête",
  "networkLog.detail.general": "Général",
  "networkLog.detail.url": "URL",
  "networkLog.detail.method": "Méthode",
  "networkLog.detail.status": "Statut",
  "networkLog.detail.time": "Durée",
  "networkLog.detail.contentType": "Content-Type",
  "networkLog.detail.requestHeaders": "En-têtes de requête",
  "networkLog.detail.responseHeaders": "En-têtes de réponse",
  "networkLog.detail.copyCurl": "Copier en cURL",
  "networkLog.detail.noBody": "Aucun corps",
  "networkLog.tab.headers": "En-têtes",
  "networkLog.tab.request": "Requête",
  "networkLog.tab.response": "Réponse",
  "networkLog.tab.messages": "Messages",
  "networkLog.ws.framesCount": "{n} trames",
  "networkLog.ws.dropped": "{n} non capturées",
  "networkLog.ws.all": "Toutes",
  "networkLog.ws.send": "Envoyées",
  "networkLog.ws.receive": "Reçues",
  "networkLog.ws.opened": "Connexion ouverte",
  "networkLog.ws.closed": "Connexion fermée ({code})",
  "networkLog.ws.empty": "Aucune trame pour l’instant",
  "networkLog.display.binary": "Réponse binaire ({type} · {size}) · Corps non enregistré",
  "networkLog.display.stream": "Réponse en streaming ({type}) · Corps non capturé",
  "networkLog.display.bodyTruncated": "Corps tronqué ({size} · plafond {limit})",
  "networkLog.display.bodyOmitted": "Corps omis (plafond mémoire)",
  "networkLog.display.pending": "En attente de réponse",
  "networkLog.display.queued": "En file d’attente",
  "networkLog.display.queueFull": "Échec · file pleine",
  "networkLog.display.aborted": "Interrompu",
  "networkLog.display.timeout": "Délai dépassé",
  "networkLog.marker.pending": "En attente",
  "networkLog.display.blocked": "Échec · statut masqué",
  "networkLog.display.blockedHint": "Le code de statut réel du serveur ne peut pas être lu à cause d’un échec CORS ou de connexion.",
  "networkLog.counter.captured": "{n} capturée(s)",

  "consoleLog.search": "Rechercher des messages…",
  "consoleLog.detail.stackTrace": "Trace de la pile",
  "consoleLog.filter.all": "Tous",
  "consoleLog.filter.error": "Erreur",
  "consoleLog.filter.warn": "Avert.",
  "consoleLog.filter.info": "Info",
  "consoleLog.filter.debug": "Debug",
  "consoleLog.filter.log": "Log",

  "actionLog.search": "Rechercher des actions…",
  "actionLog.filter.all": "Toutes",
  "actionLog.filter.click": "Clic",
  "actionLog.filter.navigation": "Navigation",
  "actionLog.filter.input": "Saisie",
  "actionLog.filter.keypress": "Touches",
  "actionLog.filter.toggle": "Bascule",
  "actionLog.filter.select": "Sélection",
  "actionLog.filter.drag": "Glissement",
  "actionLog.empty": "Aucune action capturée",
  "actionLog.verb.click": "Clic sur {target}",
  "actionLog.verb.input": "Saisie de {value} dans {field}",
  "actionLog.verb.navigate": "Navigation vers {target}",
  "actionLog.verb.navigateBack": "Retour à {target}",
  "actionLog.verb.navigateForward": "Navigation avant vers {target}",
  "actionLog.verb.navigateReload": "Rechargement de {target}",
  "actionLog.verb.navigateTraverse": "Navigation via l’historique vers {target}",
  "actionLog.verb.keypress": "Appui sur {keys}",
  "actionLog.verb.toggle.check": "Cochage de {field}",
  "actionLog.verb.toggle.uncheck": "Décochage de {field}",
  "actionLog.verb.select": "Sélection de {value} dans {field}",
  "actionLog.verb.drag": "Glissement de {source}",
  "actionLog.verb.dragTo": "Glissement de {source} vers {target}",
  "actionLog.maskedValue": "valeur masquée",
  "actionLog.role.button": "bouton",
  "actionLog.role.link": "lien",
  "actionLog.role.checkbox": "case à cocher",
  "actionLog.role.radio": "bouton radio",
  "actionLog.role.tab": "onglet",
  "actionLog.role.menuitem": "élément de menu",
  "actionLog.role.textbox": "champ de texte",

  "debug.network.empty": "Aucune requête réseau capturée",
  "debug.console.empty": "Aucun log console capturé",
  "log.originFilter.unknown": "(inconnu)",

  "logViewer.tab.report": "Rapport",
  "logViewer.tab.console": "Console",
  "logViewer.tab.network": "Réseau",
  "logViewer.tab.action": "Actions",
  "logViewer.report.untitled": "(Sans titre)",
  "logViewer.report.copyMarkdown": "Copier",
  "logViewer.report.copied": "Copié",
  "logViewer.report.empty": "Vide",
  "logViewer.report.env": "Environnement",
  "logViewer.noReport": "Aucune donnée de rapport",
  "logViewer.footer.issueLink": "Voir le ticket",
  "logViewer.video.error": "Impossible de lire la vidéo",
  "logViewer.image.error": "Impossible de charger l’image",
  "logViewer.seekTo": "Aller à {time}",
  "logViewer.noData": "Aucune donnée de log trouvée.",
  "logViewer.player.play": "Lecture",
  "logViewer.player.pause": "Pause",
  "logViewer.player.download": "Télécharger la vidéo",
  "logViewer.player.progressBar": "Barre de progression de lecture",

  "timeline.searchPlaceholder": "Rechercher dans la timeline…",
  "timeline.empty": "Aucun log enregistré sur cette plage vidéo",
  "timeline.filterEmpty": "Aucun log ne correspond au filtre actuel",
  "timeline.filter.all": "Tous",
  "timeline.filter.console": "Console",
  "timeline.filter.network": "Réseau",
  "timeline.filter.action": "Actions",
  "timeline.net.verb.fetched": "Récupération de {path}",
  "timeline.net.verb.posted": "Envoi de {path}",
  "timeline.net.verb.updated": "Mise à jour de {path}",
  "timeline.net.verb.deleted": "Suppression de {path}",
  "timeline.net.verb.checked": "Vérification de {path}",
  "timeline.net.verb.connected": "Connexion à {path}",
  "timeline.net.verb.requested": "Requête vers {path}",

  "json.showAll": "tout afficher",
  "json.moreItems": "… {n} éléments de plus",
...
export const viewerLocale = detectLocale(
  typeof navigator !== "undefined" ? navigator.language : undefined,
);
const dict = DICTS[viewerLocale];
