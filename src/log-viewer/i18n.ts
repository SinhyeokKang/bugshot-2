...
export const frDict: Record<string, string> = {
  "networkLog.search": "Rechercher URL & corps…",
  "networkLog.filter.all": "Tout",
  "networkLog.filter.json": "JSON",
  "networkLog.filter.js": "JS",
  "networkLog.filter.css": "CSS",
  "networkLog.filter.img": "Img",
  ...
  "networkLog.ws.dropped": "{n} perdues",
  "networkLog.ws.all": "Tout",
  ...
  "networkLog.counter.captured": "{n} capturées",

  "consoleLog.search": "Rechercher des messages…",
  "consoleLog.detail.stackTrace": "Stack trace",
  "consoleLog.filter.all": "Tout",
  ...
  "actionLog.verb.navigateForward": "Avance vers {target}",
