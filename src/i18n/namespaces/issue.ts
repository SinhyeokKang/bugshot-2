const ko = {
  ...
  "issue.replay.tooltip.disabled": "이슈 설정에서 30s Replay를 활성화할 수 있습니다",
  "issue.replay.tooltip.recording": "화면을 기록하고 있습니다…",
  "issue.replay.permissionRevoked":
    "캡처 권한이 해제되어 30s Replay를 껐습니다.",
...
const en = {
  ...
  "issue.replay.tooltip.disabled": "Enable 30s Replay in issue settings",
