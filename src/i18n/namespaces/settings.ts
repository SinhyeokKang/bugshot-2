...
const fr = {
  ...
  "settings.bodyLocale.auto": "Auto ({lang})",
  "settings.bodyLocale.help": "Définit la langue du rapport de bug que vous envoyez.",
  "settings.bodyComposition": "Composition du corps",
  ...
  "settings.replay.label": "Replay 30 s",
  ...
  "settings.section.media": "Médias & Logs",
  ...
  "settings.reorder.roleDescription": "triable",
  ...
  "settings.reorder.announce.start": "{label} saisi.",
  "settings.reorder.announce.move": "{label} déplacé en position {position}.",
  "settings.reorder.announce.end": "{label} déposé en position {position}.",
  "settings.reorder.announce.cancel": "Réordonnancement de {label} annulé.",
  ...
  "llm.model.placeholder": "Sélectionnez un modèle",
  ...
  "llm.error.insecureUrl": "Utilisez une adresse https. Le http simple exposerait votre clé API (localhost exempté).",
