const ko = {
  ...
  "settings.bodyLocale.help":
    "복사·제출되는 본문의 섹션 제목과 표 헤더 언어입니다. 사이드패널 화면 언어와 AI 작성 언어는 따로 설정합니다.",
...
const en = {
  ...
  "settings.issueCommon": "Common issue settings",
  ...
  "settings.bodyLocale.help":
    "The language of section headings and table headers in the body you copy or submit. The side panel language and the AI writing language are set separately.",
