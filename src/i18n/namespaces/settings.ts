const ko = {
  ...
  "settings.issueCommon": "공통",
  "settings.titlePrefix.label": "제목 접두어",
  "settings.titlePrefix.placeholder": "[QA] ",
  "settings.titlePrefix.help": "이슈 제목 앞에 붙는 접두어입니다.",
  "settings.bodyLocale": "이슈 본문 언어",
  "settings.bodyLocale.auto": "자동 ({lang})",
  "settings.bodyLocale.help": "제출하는 이슈 리포트의 언어를 설정합니다.",
  ...
  "llm.section.outputLanguage": "AI 작성 언어",
  "llm.outputLanguage.auto": "자동 ({lang})",
  "llm.outputLanguage.help": "AI 초안과 재현 단계를 이 언어로 작성합니다. 화면 언어와 별개입니다.",
  ...
  "llm.error.insecureUrl": "https 주소를 입력하세요. 평문 http로는 API 키가 그대로 노출됩니다(localhost는 예외).",
  ...
  "llm.error.empty": "AI가 결과를 만들지 못했습니다. 다시 시도하세요.",
  "llm.error.overloaded": "AI 서버가 일시적으로 과부하 상태입니다. 잠시 후 다시 시도하세요.",
  "llm.error.redirect": "엔드포인트가 리다이렉트를 반환해 API 키 보호를 위해 요청을 중단했습니다. Base URL을 확인하세요.",
...
const en = {
  ...
  "settings.issueCommon": "Common",
  "settings.titlePrefix.label": "Title prefix",
  "settings.titlePrefix.placeholder": "[QA] ",
  "settings.titlePrefix.help": "Automatically prepended to issue titles.",
  "settings.bodyLocale": "Issue body language",
  "settings.bodyLocale.auto": "Auto ({lang})",
  "settings.bodyLocale.help": "Sets the language of the issue report you submit.",
  ...
  "llm.section.outputLanguage": "AI writing language",
  "llm.outputLanguage.auto": "Auto ({lang})",
  "llm.outputLanguage.help": "AI drafts and reproduction steps are written in this language, independent of the display language.",
  ...
  "llm.error.insecureUrl": "Use an https address. Plain http would expose your API key (localhost is exempt).",
  ...
  "llm.error.empty": "The AI couldn't produce a result. Please try again.",
  "llm.error.overloaded": "AI server is temporarily overloaded. Please try again shortly.",
  "llm.error.redirect": "The endpoint returned a redirect, so the request was stopped to protect your API key. Check the base URL.",
...
const fr = {
  "settings.tab.issue": "Tickets",
  "settings.tab.ai": "Modèle IA",
  "settings.tab.general": "Général",
  "settings.issueCommon": "Commun",
  "settings.titlePrefix.label": "Préfixe du titre",
  "settings.titlePrefix.placeholder": "[QA] ",
  "settings.titlePrefix.help": "Ajouté automatiquement au début des titres de tickets.",
  "settings.bodyLocale": "Langue du corps du ticket",
  "settings.bodyLocale.auto": "Automatique ({lang})",
  "settings.bodyLocale.help": "Définit la langue du ticket que vous envoyez.",
  "settings.bodyComposition": "Composition du corps du ticket",
  "settings.recording": "Réglages d’enregistrement",
  "settings.recordingMode.label": "Mode d’enregistrement",
  "settings.recordingMode.help": "Le mode lancé par le bouton d’enregistrement. « Onglet » capture uniquement l’onglet actuel ; « Écran » capture l’écran ou la fenêtre de votre choix.",
  "settings.recordingMode.tab": "Onglet",
  "settings.recordingMode.screen": "Écran",
  "settings.replay.label": "Relecture 30 s",
  "settings.replay.help": "Conserve en permanence les 30 dernières secondes de votre écran. Un bug ? Joignez ce qui vient de se passer en vidéo, en un clic.",
  "settings.attachments.label": "Pièces jointes",
  "settings.attachments.help": "Vous pouvez joindre n’importe quel fichier à un ticket.",
  "settings.otherSection": "Autres",
  "settings.section.media": "Médias et logs",
  "settings.section.media.help": "Modifications de style d’élément, médias capturés et logs collectés.",
  "settings.reorder.reset": "Réinitialiser l’ordre",
  "settings.reorder.handle": "Réordonner {label}",
  "settings.reorder.roleDescription": "réorganisable",
  "settings.reorder.instructions": "Appuyez sur espace pour commencer à réordonner, utilisez les flèches pour déplacer, puis appuyez de nouveau sur espace pour déposer. Échap pour annuler.",
  "settings.reorder.announce.start": "Élément « {label} » saisi.",
  "settings.reorder.announce.move": "Élément « {label} » déplacé en position {position}.",
  "settings.reorder.announce.end": "Élément « {label} » déposé en position {position}.",
  "settings.reorder.announce.cancel": "Réorganisation de l’élément « {label} » annulée.",
  "settings.autoReproPrefill.label": "Remplir les étapes de reproduction",
  "settings.autoReproPrefill.help": "Envoie votre journal d’actions à l’IA connectée après l’enregistrement pour remplir les étapes de reproduction.",
  "settings.theme": "Thème",
  "settings.language": "Langue",
  "settings.theme.light": "Clair",
  "settings.theme.dark": "Sombre",
  "settings.theme.system": "Système",
  "settings.guide": "Guide BugShot",
  "settings.review": "Laisser un avis",
  "settings.contact": "Nous contacter",

  "field.issueType.select": "Choisir le type de ticket",
  "field.issueType.search": "Rechercher un type...",
  "field.issueType.empty": "Aucun type correspondant.",
  "field.priority.select": "Choisir la priorité",
  "field.priority.search": "Rechercher une priorité...",
  "field.priority.empty": "Aucune priorité correspondante.",
  "field.priority.label": "Priorité",
  "field.assignee.select": "Choisir un responsable",
  "field.assignee.search": "Rechercher par nom...",
  "field.assignee.empty": "Aucun utilisateur correspondant.",
  "field.assignee.label": "Responsable",
  "field.cc.label": "CC",
  "field.cc.select": "Choisir les utilisateurs en CC",
  "field.cc.search": "Rechercher par nom...",
  "field.cc.empty": "Aucun utilisateur correspondant.",
  "field.cc.clear": "Tout effacer",
  "field.cc.notionCapabilityError": "Votre connexion Notion n’a pas la permission d’accéder aux informations utilisateur. Reconnectez Notion dans les réglages.",
  "field.cc.submitErrorHint": "Un utilisateur sélectionné en CC n’est peut-être plus valide. Essayez d’effacer ou de resélectionner le CC.",
  "field.epic.select": "Choisir un ticket (facultatif)",
  "field.epic.search": "Rechercher des tickets...",
  "field.epic.empty": "Aucun ticket correspondant.",
  "field.epic.label": "Tickets",
  "field.sprint.select": "Choisir un sprint (facultatif)",
  "field.sprint.search": "Rechercher des sprints...",
  "field.sprint.empty": "Aucun sprint correspondant.",
  "field.sprint.label": "Sprints",

  "llm.onboarding.title": "Connecter un modèle IA",
  "llm.onboarding.body": "Connectez votre propre modèle IA pour l’utiliser avec BugShot",
  "llm.connect": "Connecter une clé API",
  "llm.dialog.title": "Connecter un modèle IA",
  "llm.dialog.body": "Sélectionnez un fournisseur et saisissez votre clé API",
  "llm.provider": "Fournisseur",
  "llm.providerCustom": "Personnalisé",
  "llm.baseUrlPlaceholder": "https://...",
  "llm.apiKey": "Clé API",
  "llm.apiKeyPlaceholder": "sk-...",
  "llm.apiKey.help": "Votre clé API est stockée uniquement sur cet appareil et envoyée directement à l’endpoint sélectionné.",
  "llm.section.connection": "Connexion",
  "llm.section.model": "Modèle",
  "llm.section.outputLanguage": "Langue de rédaction IA",
  "llm.outputLanguage.auto": "Automatique ({lang})",
  "llm.outputLanguage.help": "Les brouillons IA et les étapes de reproduction sont rédigés dans cette langue, indépendamment de la langue d’affichage.",
  "llm.model.select": "Choisir un modèle",
  "llm.model.placeholder": "Choisissez un modèle",
  "llm.model.search": "Rechercher des modèles...",
  "llm.model.empty": "Aucun modèle",
  "llm.model.refresh": "Actualiser",
  "llm.connected": "Connecté",
  "llm.disconnect": "Déconnecter",
  "llm.disconnectConfirm.title": "Déconnecter le modèle IA ?",
  "llm.disconnectConfirm.body": "Les fonctions IA de base continueront de fonctionner avec l’IA intégrée de Chrome, sans clé API.",
  "llm.error.permission": "Permission d’hôte requise. Veuillez réessayer.",
  "llm.error.invalidUrl": "Veuillez saisir une URL valide.",
  "llm.error.insecureUrl": "Utilisez une adresse https. Le protocole http non sécurisé exposerait votre clé API (localhost exempté).",
  "llm.error.fetch": "Échec de la connexion. Vérifiez l’URL et la clé API.",
  "llm.error.quota": "Quota d’API dépassé. Veuillez réessayer plus tard.",
  "llm.error.auth": "Échec de l’authentification. Vérifiez votre clé API.",
  "llm.error.empty": "L’IA n’a pas pu produire de résultat. Veuillez réessayer.",
  "llm.error.overloaded": "Le serveur IA est temporairement surchargé. Veuillez réessayer dans un instant.",
  "llm.error.redirect": "L’endpoint a renvoyé une redirection ; la requête a été arrêtée pour protéger votre clé API. Vérifiez l’URL de base.",
  "llm.error.contextOverflow": "C’est trop de contenu pour l’IA intégrée de Chrome.",
  "llm.error.contextOverflow.hint": "Connectez une clé API dans les réglages pour utiliser un modèle avec un contexte plus grand.",
} satisfies Bundle;

export const settings = { ko, en, fr };
